...
main = hakyll $ do
    ...
    tagsRules tags $ \tag pattern -> do
        ...
        compile $ do
            ...
            let tagCtx =
                    ...
                    listField "posts" (postCtxWithChipTags tags) (return posts) `mappend`
                    defaultContext
    ...
    match "posts/*" $ do
        ...
        compile $ pandocCompiler
            ...
            >>= loadAndApplyTemplate "templates/content.html" (postCtxWithChipTags tags)
...
postCtxWithChipTags tags = tagsFieldWith getTags renderTagWithChip (mconcat . intersperse " ") "chiptags" tags `mappend` (postCtxWithTags tags)
  where
    ...
    mdlChip = (H.span ! A.class_ "mdl-chip") . (H.span ! A.class_ "mdl-chip__text")
